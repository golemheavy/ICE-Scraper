...
$(document).ready(function() {
	...
	function initPage() {
		...
		$.get("/api/headlines?saved=true").then(function(data) {
			...
			if (data && data.length) {
				...
				// Otherwise render a message explaining we have no article
				renderEmpty();
			}
		});
	}
	...
	function handleNoteDelete() {
		...
		$.ajax({
			...
			bootbox.hideAll();  // I would like to improve this behavior by leaving notes up and just hiding or removing the note element which was deleted
		});
	}
